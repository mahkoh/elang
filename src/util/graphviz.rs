...
fn print_tree_<W: Write>(
    ...
    match *val {
        ...
        ExprType::Div { numer, denom, int: true } => binary!("int/", numer, denom),
        ExprType::Mod { numer, denom, int: true } => binary!("int%", numer, denom),
        ExprType::Div { numer, denom, int: false } => binary!("/", numer, denom),
        ExprType::Mod { numer, denom, int: false } => binary!("%", numer, denom),
